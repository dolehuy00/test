...
public class GUITest extends javax.swing.JFrame {
    ...
    int kindRectangle(float canh1, float canh2, float canh3) {
        ...
        boolean iscan = false;
        boolean isvuong = false;
        if(canh1==canh2 || canh1==canh3 || canh2==canh3)
            iscan = true; //TAM GIAC CAN
    ...
    void moveToErrorSection() {
        float canh1 = 0, canh2 = 0, canh3 = 0;
        try {
            canh1 = Float.parseFloat(txtCanh1.getText());
        } catch(NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Giá trị cạnh 1 phải là số nguyên dương");
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Giá trị cạnh 2 phải là số nguyên dương");
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Giá trị cạnh 3 phải là số nguyên dương");
        ...
        try {
            ...
            if(isRectangle(canh1, canh2, canh3)) {
                ...
                switch (kind) {
                    ...
                    case 2 -> txtKetQua.setText("Tam giac vuong can");
                    case 3 -> txtKetQua.setText("Tam giac can");
                    case 4 -> txtKetQua.setText("Tam giac vuong");
